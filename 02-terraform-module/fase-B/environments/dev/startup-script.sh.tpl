...
if docker run -d \
  ...
  -p 80:5000 \
  rcastro95/portfolio-backend:${image_tag}; then
...
[Service]
ExecStart=/usr/local/bin/cloud-sql-proxy --auto-iam-authn --private-ip fase-b-505318:europe-west1:dev-terraform-module-db
Restart=always
RestartSec=5
User=root
